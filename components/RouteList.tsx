      ...
      <div className="relative z-10 container mx-auto px-4 max-w-5xl w-full">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-gray-400 text-lg sm:text-xl max-w-2xl mx-auto">
            Click any route to get{' '}
            <span className="text-white font-semibold">instant price comparisons</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 max-w-4xl mx-auto">
          {POPULAR_ROUTES.map(route => {
            ...
            return (
              ...
              >
                <div
                  className={`text-lg sm:text-xl font-black flex items-center gap-3 mb-3 ${
        ...
        <div className="mt-10 text-center">
          <p className="text-sm text-gray-500">
            Estimates based on{' '}
            <span className="text-gray-400 font-medium">current traffic conditions</span>
          </p>
        </div>
      </div>
    </section>
